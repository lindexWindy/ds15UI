...
#
# Created: Wed Oct 09 10:17:25 2013
...
class Ui_beginMenu(object):
    def setupUi(self, beginMenu):
        ...
        beginMenu.resize(289, 360)
        self.frame = QtGui.QFrame(beginMenu)
        self.frame.setGeometry(QtCore.QRect(0, 0, 290, 361))
        self.frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtGui.QFrame.Raised)
        self.frame.setObjectName(_fromUtf8("frame"))
        self.singleGameButton = QtGui.QPushButton(self.frame)
        self.singleGameButton.setGeometry(QtCore.QRect(80, 30, 140, 40))
        ...
        self.webGameButton.setGeometry(QtCore.QRect(80, 90, 140, 40))
        ...
        self.websiteButton.setGeometry(QtCore.QRect(80, 160, 140, 40))
        ...
        self.teamButton.setGeometry(QtCore.QRect(80, 230, 140, 40))
        ...
        self.exitGameButton.setGeometry(QtCore.QRect(80, 300, 140, 40))
